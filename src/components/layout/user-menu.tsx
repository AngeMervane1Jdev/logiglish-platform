...
export function UserMenu({ profile }: UserMenuProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-md border border-border bg-background shadow-lg">
          <div className="p-2">
            {/* User Info */}
            ...
            <div className="py-1">
              <Link
                ...
                className={cn(
                  "flex items-center gap-2 rounded-md px-3 py-2 text-sm text-foreground-secondary transition-colors hover:bg-accent"
                )}
              >
